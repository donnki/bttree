(function () {
  ...
  p._initialize = function() {
    ...
    this.nodes.add(b3.BTSequence, true);
    this.nodes.add(b3.BTParallel, true);
    this.nodes.add(b3.BTPrioritySelector, true);
    this.nodes.add(b3.BTParallelFlexible, true);
    this.nodes.add(b3.BTCondition, true);
    this.nodes.add(b3.BTWaitAction, true);
    this.nodes.add(b3.BTRunAction, true);
