...
!function(){"use strict";var t=function(t){this.Container_constructor(),this._id=b3.createUUID(),this._editor=t,this._selectedTree=null,this._clipboard=null,this._nodes={},this.trees=null,this.nodes=null,this.history=null,this._initialize()},e=createjs.extend(t,createjs.Container);e._initialize=function(){this.trees=new b3e.project.TreeManager(this._editor,this),this.nodes=new b3e.project.NodeManager(this._editor,this),this.history=new b3e.project.HistoryManager(this._editor,this),this.nodes.add(b3e.Root,!0),this.nodes.add(b3.BTSequence,!0),this.nodes.add(b3.BTParallel,!0),this.nodes.add(b3.BTPrioritySelector,!0),this.nodes.add(b3.BTParallelFlexible,!0),this.nodes.add(b3.BTCondition,!0),this.nodes.add(b3.BTWaitAction,!0),this.nodes.add(b3.BTRunAction,!0),this._applySettings(this._editor._settings),this.history.clear(),this._editor.clearDirty()},e._applySettings=function(t){this.trees._applySettings(t),this.nodes._applySettings(t),this.history._applySettings(t)},b3e.project.Project=createjs.promote(t,"Container")}();
